...
conda install -y -c conda-forge \
    glog=0.5.0 gflags=2.2.2 protobuf freeimage=3.17 tensorboard=2.8.0 \
...
rm -rf libtorch.zip; wget -O libtorch.zip https://download.pytorch.org/libtorch/cu117/libtorch-shared-with-deps-1.13.1%2Bcu117.zip
...
# Build
cmake -DCMAKE_PREFIX_PATH="$CONDA_PREFIX/src/libtorch" -DC10_CUDA_NO_CMAKE_CONFIGURE_FILE=1 -B "$CONDA_PREFIX/src/TRIPS/build" .
