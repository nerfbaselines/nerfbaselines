...
pip install plyfile==0.8.1 'pytorch-lightning<1.0.0' 'test-tube<=0.7.5' 'kornia<=0.7.2' 'opencv-python<=4.9.0.80' 'matplotlib<=3.4.3' 'einops<='0.8.0' 'torch-optimizer<=0.3.0'
